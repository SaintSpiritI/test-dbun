...
export default class OptionMenu extends Component {
  ...
  nroMenuSubOption = (e) => {
    ...
    fetch(URL_ADMIN + 'menuOrderSubOption.class.php', reqFontPage)
  ...
  subOptionMenuSubmit = (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      fetch(URL_ADMIN + 'menuSubOptionModify.class.php', reqFontPage)
        .then((response) => response.json())
        .then((data) => {
          if (data.msm == 'false') {
            this.setState({ msm: false, msmStatus: true });
  ...
  dteMenuSubOption = () => {
    ...
    fetch(URL_ADMIN + 'menuDeleteSubOption.class.php', reqFontPage)
      .then((response) => response.json())
      .then((data) => {
        if (data.msm == 'false') {
          this.setState({ msm: false, msmStatus: true });
      ...
      <div className="w-100 d-flex">
        ...
        >
          ...
          <ButtonGroup className="w-25" aria-label="First group">
            <Form.Control
              ...
              type="number"
              min="0"
              onChange={this.nroMenuSubOption}
            />
          </ButtonGroup>
        </ButtonToolbar>
        <Offcanvas
        ...
        >
          <Offcanvas.Header closeButton>
            <Offcanvas.Title>Opción de Sub Menú</Offcanvas.Title>
          </Offcanvas.Header>
          <Offcanvas.Body>
            <Card>
              <Form
                ...
                onSubmit={this.subOptionMenuSubmit}
