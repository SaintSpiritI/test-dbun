...
export default class OptionFooter extends Component {
  ...
  nroFooterSubOption = (e) => {
    ...
    fetch(URL_ADMIN + 'footerOrderSubOption.class.php', reqFontPage)
  ...
  dteFooterSubOption = () => {
    ...
    fetch(URL_ADMIN + 'footerDeleteSubOption.class.php', reqFontPage)
      .then((response) => response.json())
      .then((data) => {
        if (data.msm == 'false') {
          this.setState({ msm: false, msmStatus: true });
  ...
  subOptionFooterSubmit = (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      fetch(URL_ADMIN + 'footerSubOptionModify.class.php', reqFontPage)
        .then((response) => response.json())
        .then((data) => {
          if (data.msm == 'false') {
            this.setState({ msm: false, msmStatus: true });
      ...
      <div className="w-100 d-flex">
        ...
        >
          ...
          <ButtonGroup className="w-25" aria-label="First group">
            <Form.Control
              ...
              onChange={this.nroFooterSubOption}
              type="number"
              min="0"
            />
          </ButtonGroup>
        ...
        >
          <Offcanvas.Header closeButton>
            <Offcanvas.Title>Opción de Texto</Offcanvas.Title>
          </Offcanvas.Header>
          <Offcanvas.Body>
            <Card>
              <Form
                ...
                onSubmit={this.subOptionFooterSubmit}
            ...
            <Button
              ...
              className="w-50 my-4 "
              onClick={this.dteFooterSubOption}
            >
              Eliminar Texto
            </Button>
